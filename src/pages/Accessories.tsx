...
const Accessories = () => {
  ...
  const printIssueVoucher = (asset: any) => {
    ...
    const desc = `${esc(asset.device_type || "Device")}: Model: ${esc(asset.specification || "-")}${asset.sl_no ? `  SL: ${esc(asset.sl_no)}` : ""
    ...
    <div className="w-full p-3 sm:p-6 space-y-6 sm:space-y-8 bg-gradient-to-br from-sky-50 to-blue-50 dark:from-slate-900 dark:to-slate-800 min-h-screen">
      ...
      <Card className="bg-transparent border-2 border-sky-400 dark:border-sky-600 shadow-none">
        ...
        <CardContent>
          ...
          <div className="rounded-2xl border-2 border-primary/60 dark:border-primary/70 overflow-x-auto shadow-[0_10px_30px_-12px_hsl(var(--primary)/0.25)]">
            <Table className="min-w-[900px] border-collapse [&_th]:border [&_th]:border-primary/60 dark:[&_th]:border-primary/70 [&_td]:border [&_td]:border-primary/20 dark:[&_td]:border-primary/40">
              <TableHeader>
                <TableRow className="!bg-transparent hover:!bg-transparent border-b-2 border-primary/70">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              ...
              <div>
                ...
                <Input
                  ...
                  required
                  className={`focus:border-sky-400 ${formData.pc_no && accessories.some((a: any) =>
              ...
              <div>
                ...
                <Input
                  ...
                  className={`focus:border-sky-400 ${formData.ip_no && accessories.some((a: any) =>
