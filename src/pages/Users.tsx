      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center space-x-2">
          <Button variant="outline" onClick={() => {
            ...
            const content = `<!DOCTYPE html><html><head><title>Users List</title><style>@page { size: A4 landscape; margin: 10mm; } body { font-family: Arial, sans-serif; } .header { text-align: center; margin-bottom: 20px; } .header img { height: 50px; } .header h1 { color: #0284c7; } table { width: 100%; border-collapse: collapse; } th { background: #0284c7; color: white; padding: 10px; border: 1px solid #ddd; } td { padding: 8px; }</style></head><body><div class="header"><img src="/lovable-uploads/20eb7d56-b963-4a41-9830-eead460b0120.png" /><h1>MNR Group - Users List</h1></div><table><thead><tr><th>Name</th><th>Email</th><th>Department</th><th>Position</th><th>Antivirus</th><th>Expiry</th></tr></thead><tbody>${rows}</tbody></table></body></html>`;
