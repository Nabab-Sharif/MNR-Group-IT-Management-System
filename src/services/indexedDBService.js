...
// Full app data is kept in IndexedDB as the source of truth.
// Cloud access is intentionally disabled here so the browser database
// always holds the complete dataset for the management app.
const CLOUD_STORES = {};

const isCloud = () => false;
const cloudTable = () => null;
